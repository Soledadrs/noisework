...
export const getCurrentTime = () => {
  ...
  let weekday = ["礼拜日", "礼拜一", "礼拜二", "礼拜三", "礼拜四", "礼拜五", "礼拜六"];
  let currentTime = {
    year,
    month,
    day,
...
export const helloInit = () => {
  ...
  ElMessage({
    ...
    message: `<strong>${hello}</strong> 欢迎嚟到Soledad's HomePage`,
  });
};
...
export const siteDateStatistics = (startDate) => {
  ...
  return `Soledad搞机几耐： ${years} 年零 ${months} 嗰月零 ${days} 日`;
};
