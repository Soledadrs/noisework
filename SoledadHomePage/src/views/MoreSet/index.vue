    ...
    <el-row :gutter="40">
      <el-col :span="12" class="left">
        ...
        <div class="version">
          ...
          <el-tooltip content="Soledad's Github" placement="right" :show-arrow="false">
      ...
      <el-col :span="12" class="right">
        <div class="title">
          ...
          <span class="name">Soledad's 全局调配</span>
        </div>
        <Set />
      </el-col>
    </el-row>
...
const siteUrl = computed(() => {
  ...
  if (!url) return "277711.xyz".split(".");
  // 判断协议前缀
...
const upData = reactive({
  new: [
    ...
    "人生有两种境界，一种喺痛而不言，一种喺笑而不语",
    "成熟喺個很痛嘅词，唔一定会得到，就一定会失去",
  ],
  fix: ["唯有当黑夜完全黑晒", "先至会见到星星", "撑不住個阵", "同自己讲声“我好攰”唔好喺個心度承认“我唔得”"],
});
