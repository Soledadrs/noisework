<template>
  <div class="setting">
    <el-collapse class="collapse" v-model="activeName" accordion>
      <el-collapse-item title="個性壁纸调配" name="1">
        <div class="bg-set">
      ...
      <el-collapse-item title="个性化调配" name="2">
        <div class="item">
          <span class="text">建站几耐系咪显示</span>
          <el-switch
        ...
        <div class="item">
          <span class="text">音乐点击系咪打开個面板</span>
          <el-switch
            v-model="musicClick"
            inline-prompt
            :active-icon="CheckSmall"
      ...
      <el-collapse-item title="播放器调配" name="3">
        <div class="item">
          <span class="text">系咪自动播放</span>
          <el-switch
        ...
        <div class="item">
          ...
          <el-radio-group v-model="playerLoop" size="small" text-color="#FFFFFF">
            ...
            <el-radio value="none" border>唔循环</el-radio>
          </el-radio-group>
        </div>
      </el-collapse-item>
      <el-collapse-item title="啲湿碎调配" name="4">
        <div>调配内容待增加</div>
      </el-collapse-item>
    </el-collapse>
  </div>
